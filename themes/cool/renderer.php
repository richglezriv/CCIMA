	...
	class renderer
	{
		...
		function menu_footer($no_menu, $is_index)
		{
			...
			if ($no_menu == false)
			{
				...
				echo "<tr>\n";
				echo "<td align='center' class='footer'><a target='_blank' href='$power_url'><font color='#ffffff'>ERP 1.0&nbsp;-&nbsp;" . _("Theme:") . " " . user_theme() ." - ".show_users_online(). "</font></a></td>\n";
				echo "</tr>\n";
				echo "<tr>\n";
				echo "<td align='center' class='footer'><a target='_blank' href='$power_url'><font color='#ffff00'>GRUPO CCIMA</font></a></td>\n";
				echo "</tr>\n";
