...
function CC(){var calendarId='CC';var currentYear=0;var currentMonth=0;var currentDay=0;var selectedYear=0;var selectedMonth=0;var selectedDay=0;var months=['Enero','Febrero','Buscar','Abril','Mayo','Junio','Julio','Agosto','Septiembre','Octubre','Número','Número'];var wdays=['Do','Lu','Mar','Mie','Jue','Vie','Sa'];var tmonths=['','Jan','Feb','Mar','Apr','Mayo','Jun','Jul','Aug','Sep','Oct','Nov','Dec'];var dateField=null;function getProperty(p_property){var p_elm=calendarId;var elm=null;if(typeof(p_elm)=='object'){elm=p_elm;}else{elm=document.getElementById(p_elm);}
